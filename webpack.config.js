...
module.exports = {
    entry: {
        ...
        "examples/fake-sensor-bar-preload-temperature-pause": "./src/examples/fake-sensor-bar-preload-temperature-pause.tsx",
        "examples/fake-sensor-bar-preload-position-pause": "./src/examples/fake-sensor-bar-preload-position-pause.tsx",
        "examples/fake-sensor-bar-preload-temperature-ondemand": "./src/examples/fake-sensor-bar-preload-temperature-ondemand.tsx",
        "examples/fake-sensor-bar-preload-position-ondemand": "./src/examples/fake-sensor-bar-preload-position-ondemand.tsx",
        ...
        "examples/fake-sensor-bar-preload-predict-temperature-pause": "./src/examples/fake-sensor-bar-preload-predict-temperature-pause.tsx",
        "examples/fake-sensor-bar-preload-predict-position-pause": "./src/examples/fake-sensor-bar-preload-predict-position-pause.tsx",
        "examples/fake-sensor-bar-preload-predict-temperature-ondemand": "./src/examples/fake-sensor-bar-preload-predict-temperature-ondemand.tsx",
        "examples/fake-sensor-bar-preload-predict-position-ondemand": "./src/examples/fake-sensor-bar-preload-predict-position-ondemand.tsx",
        ...
        "examples/fake-sensor-line-preload-temperature-pause": "./src/examples/fake-sensor-line-preload-temperature-pause.tsx",
        "examples/fake-sensor-line-preload-position-pause": "./src/examples/fake-sensor-line-preload-position-pause.tsx",
        "examples/fake-sensor-line-preload-temperature-ondemand": "./src/examples/fake-sensor-line-preload-temperature-ondemand.tsx",
        "examples/fake-sensor-line-preload-position-ondemand": "./src/examples/fake-sensor-line-preload-position-ondemand.tsx",
        ...
        "examples/fake-sensor-line-preload-predict-temperature-pause": "./src/examples/fake-sensor-line-preload-predict-temperature-pause.tsx",
        "examples/fake-sensor-line-preload-predict-position-pause": "./src/examples/fake-sensor-line-preload-predict-position-pause.tsx",
        "examples/fake-sensor-line-preload-predict-temperature-ondemand": "./src/examples/fake-sensor-line-preload-predict-temperature-ondemand.tsx",
        "examples/fake-sensor-line-preload-predict-position-ondemand": "./src/examples/fake-sensor-line-preload-predict-position-ondemand.tsx",
