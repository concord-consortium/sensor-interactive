...
context('Sensor Bar Preload Temperature Pause Ondemand',()=>{
    it('Sensor Bar Preload Temperature Pause Ondemand',()=>{
        // See cypress.json for viewport size
        cy.viewport(1400,1280)
        cy.visit('/examples/fake-sensor-bar-preload-predict-temperature-pause-ondemand.html')
