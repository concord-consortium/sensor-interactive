...
context('Sensor Line Preload Position Pause Ondemand',()=>{
    it('Sensor Line Preload Position Pause Ondemand',()=>{
        // See cypress.json for viewport size
        cy.viewport(1400,1280)
        cy.visit('/examples/fake-sensor-line-preload-predict-position-pause-ondemand.html')
