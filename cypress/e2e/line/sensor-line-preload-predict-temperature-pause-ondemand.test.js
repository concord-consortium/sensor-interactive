...
context('Sensor Line Preload Temperature Pause Ondemand',()=>{
    it('Sensor Line Preload Temperature Pause Ondemand',()=>{
        // See cypress.json for viewport size
        cy.viewport(1400,1280)
        cy.visit('/examples/fake-sensor-line-preload-predict-temperature-pause-ondemand.html')
